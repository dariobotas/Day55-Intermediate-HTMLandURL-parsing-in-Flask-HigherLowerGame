...
@app.route(
    '/username/<name>'
)  # route with variables. The updates to the route need to refresh the server.
def greet(name):
  return f"Hello {name}"
...
if __name__ == "__main__":
  ...
  )  # activate debug: debug=True -> able to make changes to flask without need to refresh the server
